...
export default function WelcomeScreen({navigation}: Props) {
  ...
  return (
    <LinearGradient
      ...
      {/* Hero */}
      <View style={[styles.hero, {paddingTop: insets.top + verticalScale(28)}]}>
      ...
      {/* Features */}
      <View style={styles.featuresWrap} accessibilityLabel="App features">
      ...
      {/* CTA */}
      <View style={[styles.bottomWrap, {paddingBottom: insets.bottom + verticalScale(28)}]}>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  bottomWrap: {paddingHorizontal:scale(24), marginTop:'auto', gap:verticalScale(14)},
